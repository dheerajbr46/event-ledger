...
import com.example.gateway.repo.EventRepository;
import com.example.gateway.web.dto.BalanceResponse;
import com.example.gateway.web.dto.EventResponse;
import com.example.gateway.web.dto.SubmitEventRequest;
...
public class EventService {
    ...
    public EventResponse getEvent(String eventId) {
        return repository
                ...
                .orElseThrow(() -> new com.example.gateway.web.EventNotFoundException(eventId));
    }
